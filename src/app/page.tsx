    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="text-center mb-8 pt-8">
          ...
          <p className="text-slate-600 text-lg">Test your knowledge and prepare for PhilNITS October 2025</p>
        </div>
        ...
        <div className="text-center mt-12 pb-8">
          <p className="text-slate-500 text-sm">Good luck with your exam! Remember to stay calm and focused.</p>
        </div>
      </div>
    </div>
  )
